<template>
  <el-dialog title="日志列表" :close-on-click-modal="false" :visible.sync="visible" width="75%">
    ...
    <el-table :data="dataList" border v-loading="dataListLoading" height="460" style="width: 100%;">
      ...
      <el-table-column prop="beanName" header-align="center" align="center" width="160" label="bean名称">
      </el-table-column>
      <el-table-column prop="params" header-align="center" align="center" label="参数" :show-overflow-tooltip='true'>
      </el-table-column>
      ...
      <el-table-column prop="info" header-align="center" align="center" label="执行信息" :show-overflow-tooltip='true'>
      </el-table-column>
      <el-table-column prop="times" header-align="center" align="center" width="160" label="耗时(单位: 毫秒)">
      </el-table-column>
      <el-table-column prop="createTime" header-align="center" align="center" width="160" label="执行时间">
      </el-table-column>
    </el-table>
