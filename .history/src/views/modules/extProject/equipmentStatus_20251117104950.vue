  ...
  <script>
    ...
    function drawChart() {
      ...
      for (let i = 0; i < zoneCount; i++) {
        ...
        if (i === 0) {
          // 上层“设定值”无框
          graphics.push({ type: 'text', style: { x: x-55, y: topY + 25, text: '设定值', font: '12px monospace', fill: '#333' } });
          ...
          // 下层“设定值”无框
          graphics.push({ type: 'text', style: { x: x-55, y: bottomY + 45, text: '设定值', font: '12px monospace', fill: '#333' } });
        }
